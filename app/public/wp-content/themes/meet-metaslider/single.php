		...
		<main id="main" class="site-main">
			...
			while ( have_posts() ) : the_post();
				...
				if ( get_theme_mod( 'postpage_show_author' ) == '1' ) :
					...
					echo '<h3>';
					echo esc_html_e('About the author','meet-metaslider');
					echo '</h3>';
				...
				if ( get_theme_mod( 'postpage_show_hide_relatedposts' ) != '1' ) :
					...
					if ($categories) { $category_ids = array(); 
						...
						$my_query = new wp_query( $args ); if( $my_query->have_posts() ) {
							echo '<div class="related-posts"><div class="related-posts-headline"><h3>'.esc_html__('Related Posts', 'meet-metaslider').'</h3></div><div class="related-posts-posts">';
									...
									<div class="article-contents">
										<header class="entry-header">
											...
											if ( 'post' === get_post_type() ) :
												...
												<a class="read-more" href="<?php esc_url(the_permalink()); ?>" title="<?php esc_html(the_title_attribute()); ?>">
													<?php echo esc_html_e('Read More','meet-metaslider'); ?>
												</a>
											<?php endif; ?>
										</div>
										<?php  ?>
